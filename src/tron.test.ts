...
describe('Score outcomes', () => {
    test('2 players', () => {
        expect(
            scoreResults(
                [
                    {dir: 'EAST', depth: 87, isDead: [true, false]},
                    {dir: 'EAST', depth: 206, isDead: [false, true]},
                    {dir: 'EAST', depth: 87, isDead: [true, false]},
                    {dir: 'EAST', depth: 192, isDead: [false, true]},
                    {dir: 'EAST', depth: 37, isDead: [false, true]},
                    {dir: 'WEST', depth: 113, isDead: [false, true]},
                    {dir: 'WEST', depth: 113, isDead: [false, true]},
                    {dir: 'WEST', depth: 46, isDead: [true, false]},
                    {dir: 'NORTH', depth: 207, isDead: [false, true]},
                    {dir: 'NORTH', depth: 111, isDead: [false, true]},
                    {dir: 'NORTH', depth: 207, isDead: [false, true]},
                    {dir: 'NORTH', depth: 111, isDead: [false, true]},
                    {dir: 'NORTH', depth: 180, isDead: [false, true]},
                    {dir: 'NORTH', depth: 86, isDead: [false, true]},
                    {dir: 'NORTH', depth: 82, isDead: [false, true]},
                    {dir: 'SOUTH', depth: 77, isDead: [false, true]},
                    {dir: 'SOUTH', depth: 226, isDead: [true, false]},
                    {dir: 'SOUTH', depth: 208, isDead: [true, false]},
                ],
                2,
            ),
        ).toMatchSnapshot();
        expect(
            scoreResults(
                [
                    {dir: 'NORTH', depth: 10, isDead: [true, false]},
                    {dir: 'SOUTH', depth: 54, isDead: [false, true]},
                ],
                2,
            ),
        ).toMatchSnapshot();
